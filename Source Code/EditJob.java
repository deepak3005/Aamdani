...
public class EditJob extends JFrame {
	...
	public void setValuesToEditPage()
	{
		...
		//jobnoentered = ShopkeeperDashboard.Job_Number_Entered.getText();
		
		try 
        {
        	Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/aamdani", "root", "root");
               
            String query = "SELECT Title,Decription,Location,Distance_From_UPES,Hourly_Stipend,Start_Time,End_Time FROM jobs_posted WHERE Email_Address='"+getEmailId+"'  and Title ='"+ShopkeeperDashboard.SelectedRowTitle+"' and Location ='"+ShopkeeperDashboard.SelectedRowLocation+"' and Distance_From_UPES ='"+ShopkeeperDashboard.SelectedRowDistance+"' and Hourly_Stipend ='"+ShopkeeperDashboard.SelectedRowStipend+"' and Start_Time ='"+ShopkeeperDashboard.SelectedRowStart+"' and End_Time ='"+ShopkeeperDashboard.SelectedRowEnd+"'";
			...
			public void mouseClicked(MouseEvent e) 
			{
                ...
                else
                {
                	try 
                	{
                        ...
                        String query4 = "UPDATE jobs_posted SET Hourly_Stipend='"+JobStipend+"' WHERE Email_Address='"+ShopkeeperEmail+"' and Title='"+JobTitle+"'";
                        String query5 = "UPDATE jobs_posted SET Distance_From_UPES='"+JobDistance+"' WHERE Email_Address='"+ShopkeeperEmail+"' and Title='"+JobTitle+"'";
